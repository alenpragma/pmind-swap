  ...
  return (
    <div>
      ...
      <div className="flex gap-5 mt-[18px] mx-auto justify-center">
        ...
        <div className="w-[560px] h-[662px] px-6 py-7 border-[1px] bg-[#EDEDED] border-[#B6B6B6] rounded-2xl">
          <div className="font-semibold text-center">
            {/*  */}
            ...
            {/* data */}
            {/* ************ */}
            <div className="flex   place-items-center justify-between mt-[30px] ">
            ...
            <div className="h-[529px] w-full bg-white rounded-2xl mt-10 flex place-items-center">
              {/* <img src={chart} alt="" /> */}
