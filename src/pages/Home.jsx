...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row gap-5 mt-[18px] mx-auto justify-center">
        {/* ************ */}
        {/* 1 st */}
        {/* ************ */}
        <div className=" w-[400px] lg:w-[560px] h-[662px] mx-auto px-3 border-[1px] bg-[#EDEDED] border-[#B6B6B6] rounded-2xl">
          <div className="font-semibold text-center">
            ...
            <button className="bg-secondary mt-9 rounded-2xl w-full lg:w-[477px] h-[55px]">Connect Wallet</button>
          </div>
        </div>
        ...
        <div className=" w-[400px] lg:w-[560px] mx-auto h-[662px] px-6 py-7 border-[1px] bg-[#EDEDED] border-[#B6B6B6] rounded-2xl">
          <div className="font-semibold text-center">
            ...
            {/* data */}
            {/* ************ */}
            <div className="flex gap-2.5  flex-col lg:flex-row  place-items-center justify-between mt-[30px] ">
              <div className="flex gap-3 w-full justify-start mx-auto">
            ...
            <div className="h-full mb-0 lg:h-[500px] mt-2 w-full bg-white rounded-2xl flex place-items-center">
              {/* <img src={chart} alt="" /> */}
